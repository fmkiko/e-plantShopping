        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div className='cart-container'> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                            ...
                            <div className='cart_quantity_count' onClick={(e) => handleCartClick(e)} >
                                {handledCartCount()}
                            </div>
